...
fanr publish -r http://repo.status302.com/fanr/ ${env}camGoPlugin.pod
fanr publish -r http://repo.status302.com/fanr/ ${env}camGradlePlugin.pod
fanr publish -r http://repo.status302.com/fanr/ ${env}camPhpPlugin.pod
